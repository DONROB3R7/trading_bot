    ...
    try {
        ...
        if (
            ...
            if (
                ...
                console.log(
                    `${symbol}: CLOSE_LONG received but current position is ${current.direction}. No action.`
                );
            ...
            if (
                ...
                console.log(
                    `${symbol}: CLOSE_SHORT received but current position is ${current.direction}. No action.`
                );
            ...
            console.log(
                `${symbol}: closing ${current.direction} position`
            );
...
app.get(
    ...
    (
        ...
        res.json({
            ...
            behavior:
                "LONG/SHORT automatic reversal per symbol + CLOSE_LONG/CLOSE_SHORT",
...
app.listen(
    ...
    async () => {
        ...
        try {
            ...
            console.log(
                "Supported TradingView close alerts:"
            );
